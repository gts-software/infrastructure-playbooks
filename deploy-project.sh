...
cd "$PLAYBOOK_DIR"
ansible-playbook $PLAYBOOK_DIR/deploy-project.yml -v -e docker_pull=$DOCKER_PULL -e project_mode=$PROJECT_MODE -e project_branch=$PROJECT_BRANCH -e project_version=$PROJECT_VERSION -e @$PROJECT_SOURCE/project.yml
